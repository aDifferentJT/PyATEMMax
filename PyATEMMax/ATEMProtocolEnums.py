...
class ATEMVideoSources(ATEMConstantList):
    ...
    auxilary25 = ATEMConstant('auxilary25', 8025)
    auxilary26 = ATEMConstant('auxilary26', 8026)
    auxilary27 = ATEMConstant('auxilary27', 8027)
    auxilary28 = ATEMConstant('auxilary28', 8028)
    auxilary29 = ATEMConstant('auxilary29', 8029)
    auxilary30 = ATEMConstant('auxilary30', 8030)
...
class ATEMAUXChannels(ATEMConstantList):
    ...
    auxChannel7 = ATEMConstant('auxChannel7', 6)
    auxChannel8 = ATEMConstant('auxChannel8', 7)
    auxChannel9 = ATEMConstant('auxChannel9', 8)
    auxChannel10 = ATEMConstant('auxChannel10', 9)
    auxChannel11 = ATEMConstant('auxChannel11', 10)
    auxChannel12 = ATEMConstant('auxChannel12', 11)
    auxChannel13 = ATEMConstant('auxChannel13', 12)
    auxChannel14 = ATEMConstant('auxChannel14', 13)
    auxChannel15 = ATEMConstant('auxChannel15', 14)
    auxChannel16 = ATEMConstant('auxChannel16', 15)
    auxChannel17 = ATEMConstant('auxChannel17', 16)
    auxChannel18 = ATEMConstant('auxChannel18', 17)
    auxChannel19 = ATEMConstant('auxChannel19', 18)
    auxChannel20 = ATEMConstant('auxChannel20', 19)
    auxChannel21 = ATEMConstant('auxChannel21', 20)
    auxChannel22 = ATEMConstant('auxChannel22', 21)
    auxChannel23 = ATEMConstant('auxChannel23', 22)
    auxChannel24 = ATEMConstant('auxChannel24', 23)
    auxChannel25 = ATEMConstant('auxChannel25', 24)
    auxChannel26 = ATEMConstant('auxChannel26', 25)
    auxChannel27 = ATEMConstant('auxChannel27', 26)
    auxChannel28 = ATEMConstant('auxChannel28', 27)
    auxChannel29 = ATEMConstant('auxChannel29', 28)
    auxChannel30 = ATEMConstant('auxChannel30', 29)
    auxChannel31 = ATEMConstant('auxChannel31', 30)
    auxChannel32 = ATEMConstant('auxChannel32', 31)
